...
public class TraderRepository {
    ...
    public List<Ticker> getActiveTickersList() {
        System.out.println("AccountRepository getActiveTickers");
        String sql = "SELECT * FROM ticker ";
        List<Ticker> ticker = new ArrayList<>();
        //List<Ticker> tickers = jdbcTemplate.query(sql, new HashMap<>(), new AccountRowMapper());
        return ticker;
    }
